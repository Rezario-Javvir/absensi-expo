...
const CreateClass = ({ isVisible, onClose }) => {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            const url = 'https://kfbt6z3d-3000.asse.devtunnels.ms/kelas/auth/register';
            ...
            Alert.alert('Gagal', error.response?.data?.message || 'Gagal membuat kelas');
        } finally {
            setLoading(false);
        }
    }
        ...
        <Modal visible={isVisible} transparent animationType="fade">
            <View className='flex-1 justify-center items-center bg-black/50 px-10'>
                <View className='w-full bg-white rounded-3xl p-8 items-center shadow-2xl'>
                    <Text className='text-2xl font-black mb-8 text-matcha-green-100'>Buat Kelas Baru</Text>
                    ...
                    <View className='flex-row gap-4 w-full'>
                        ...
                        >
                            {loading ? (
                                ...
                                <Text className='text-white font-bold text-center'>Simpan</Text>
                            )}
                        </Pressable>
                    </View>
                </View>
